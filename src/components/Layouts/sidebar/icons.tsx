...
export function ContractIcon(props: PropsType) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
      ...
      {...props}
    >
      <rect x={6} y={2} width={16} height={20} rx={2} fill="#000000" />
      <path
        d="M19 18H15a1 1 0 0 1 0-2h4a1 1 0 0 1 0 2ZM3.69 5.3 2.29 6.7a1 1 0 0 0 0 1.4L8.9 14.71a1 1 0 0 0 .71.3H11a1 1 0 0 0 1-1V12.62a1 1 0 0 0-.29-.71L5.09 5.3a1 1 0 0 0-1.4 0Z"
        fill="#2ca9bc"
      />
    </svg>
  );
